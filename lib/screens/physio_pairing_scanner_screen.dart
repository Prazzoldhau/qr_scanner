...
class PhysioPairingScannerScreen extends StatefulWidget {
  ...
  @override
  State<PhysioPairingScannerScreen> createState() => _PhysioPairingScannerScreenState();
}

class _PhysioPairingScannerScreenState extends State<PhysioPairingScannerScreen> with WidgetsBindingObserver {
      ...
      body: Stack(
        ...
        children: [
          ...
          const Positioned(
            ...
            right: 0,
            child: Text(
              'Point your camera at your physio\'s pairing QR code',
              textAlign: TextAlign.center,
